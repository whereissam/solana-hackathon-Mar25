...
const homeHeader = (
  ...
  >
    ...
    >
      Connect your wallet, donate through Solana, and receive a verifiable proof
      of your contribution. Empower your generosity with transparency and trust.
    </Typography>
    <Box
      sx={{
        flexGrow: 0,
...
const howItWorks = (
  <Box component={"section"} sx={sectionStyle}>
    ...
    >
      <img style={{ marginRight: 40 }} src="/img/howItWorks_1.png" />
      <img
        style={{ marginTop: 0, marginRight: 5 }}
        src="/img/howItWorks_2.png"
      />
      <img style={{ marginTop: 0 }} src="/img/howItWorks_3.png" />
    </Box>
    <Carousel
      duration={1000}
      autoPlay={true}
    ...
    >
      <img src="/img/howItWorks_1.png" />
      <img src="/img/howItWorks_2.png" />
      <img src="/img/howItWorks_3.png" />
    </Carousel>
  </Box>
);
...
const TeamCard = ({ image, name, position, description, email, linkedin }) => {
  return (
    <Card sx={{ width: "267px" }}>
      <CardMedia sx={{ height: 230 }} title={name} image={image}></CardMedia>
      <CardContent>
        <Typography variant="h5">{name}</Typography>
        <Typography variant="subtitle1">{position}</Typography>
      </CardContent>
      <CardActionArea sx={{ display: "none", flexDirection: "row", mb: 2 }}>
        <IconButton>
          <EmailIcon />
        </IconButton>
        <IconButton>
