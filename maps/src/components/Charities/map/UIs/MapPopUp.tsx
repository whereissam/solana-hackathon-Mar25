        ...
        donateButton.addEventListener("click", (e) => {
          ...
          const mockBeneficiaries = [
            ...
            },
            {
              ...
              first_name: "Bella",
              last_name: "Williams",
              email: "bella.williams@email.com",
            },
            {
              id: "4",
              first_name: "Charlie",
                ...
                ${mockBeneficiaries
                  ...
                  <div class="bg-white rounded-lg shadow-md overflow-hidden transform transition-transform duration-200 hover:scale-105">
                    ...
                    <div class="p-3">
                      ...
                      >
                        <a href="https://solana-hackathon-mar25.vercel.app/beneficiaries/3"> Donate to ${beneficiary.first_name}</a>
          ...
          const beneficiaryButtons = beneficiaryContent.querySelectorAll(
            "button[data-beneficiary-id]"
          );
          beneficiaryButtons.forEach((button) => {
            button.addEventListener("click", (e) => {
              e.stopPropagation();
              const beneficiaryId = (button as HTMLElement).dataset
                .beneficiaryId;
              if (onDonateClick && charity) {
                const selectedBeneficiary = mockBeneficiaries.find(
